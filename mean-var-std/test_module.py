...
class UnitTests(unittest.TestCase):
    def test_calculate(self):
        actual = mean_var.calculate([2,6,2,8,4,0,1,5,7])
    ...
    def test_calculate2(self):
        actual = mean_var.calculate([9,1,5,3,3,3,2,9,0])
    ...
    def test_calculate_with_few_digits(self):
        self.assertRaisesRegex(ValueError, "List must contain nine numbers.", mean_var.calculate, [2,6,2,8,4,0,1,])
